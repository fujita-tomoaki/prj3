...
//--- プロパティメソッド
     ...
     * @return 連携番号 を戻します。
     */
    @LogInfo(columnIndex=2,columnJpName="連携番号")
     ...
     * @return 連携番号連番 を戻します。
     */
    @LogInfo(columnIndex=3,columnJpName="連携番号連番")
     ...
     * @return 連携要求日時 を戻します。
     */
    @LogInfo(columnIndex=4,columnJpName="連携要求日時")
     ...
     * @return 処理状況 を戻します。
     */
    @LogInfo(columnIndex=5,columnJpName="処理状況")
     ...
     * @return サービスID を戻します。
     */
    @LogInfo(columnIndex=6,columnJpName="サービスID")
     ...
     * @return 顧客コード を戻します。
     */
    @LogInfo(columnIndex=7,columnJpName="顧客コード")
     ...
     * @return 連番 を戻します。
     */
    @LogInfo(columnIndex=8,columnJpName="連番")
     ...
     * @return 更新フラグ を戻します。
     */
    @LogInfo(columnIndex=9,columnJpName="更新フラグ")
     ...
     * @return 申込種別 を戻します。
     */
    @LogInfo(columnIndex=10,columnJpName="申込種別")
     ...
     * @return 連携日時 を戻します。
     */
    @LogInfo(columnIndex=11,columnJpName="連携日時")
     ...
     * @return 通信結果 を戻します。
     */
    @LogInfo(columnIndex=12,columnJpName="通信結果")
     ...
     */
    @LogInfo(columnIndex=13,columnJpName="通信ステータス")
     ...
     * @return サービス結果 を戻します。
     */
    @LogInfo(columnIndex=14,columnJpName="サービス結果")
     ...
     */
    @LogInfo(columnIndex=15,columnJpName="サービスエラー理由")
     ...
     * @return 連携結果 を戻します。
     */
    @LogInfo(columnIndex=16,columnJpName="連携結果")
     ...
     */
    @LogInfo(columnIndex=17,columnJpName="連携エラー理由")
     ...
     * @return 申込番号 を戻します。
     */
    @LogInfo(columnIndex=18,columnJpName="申込番号")
     ...
     * @return 廃止取次番号 を戻します。
     */
    @LogInfo(columnIndex=19,columnJpName="廃止取次番号")
     ...
     * @return ご連絡事項 を戻します。
     */
    @LogInfo(columnIndex=20,columnJpName="ご連絡事項")
     ...
     * @return 優先度 を戻します。
     */
    @LogInfo(columnIndex=21,columnJpName="優先度")
     ...
     */
    @Override
    @LogInfo(columnIndex=22,columnJpName="登録者")
     ...
     */
    @Override
    @LogInfo(columnIndex=23,columnJpName="登録日")
     ...
     */
    @Override
    @LogInfo(columnIndex=24,columnJpName="更新者")
     ...
     */
    @Override
    @LogInfo(columnIndex=25,columnJpName="更新日")
     ...
     * @return 更新APP を戻します。
     */
    @LogInfo(columnIndex=26,columnJpName="更新APP")
     ...
     */
    @LogInfo(columnIndex=27,columnJpName="バージョン番号")
