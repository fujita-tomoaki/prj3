...
//--- プロパティメソッド
     ...
     * @return 顧客コード を戻します。
     */
    @LogInfo(columnIndex=2,columnJpName="顧客コード")
     ...
     * @return 区分 を戻します。
     */
    @LogInfo(columnIndex=3,columnJpName="区分")
     ...
     * @return 区分連番 を戻します。
     */
    @LogInfo(columnIndex=4,columnJpName="区分連番")
     ...
     * @return 顧客状態 を戻します。
     */
    @LogInfo(columnIndex=5,columnJpName="顧客状態")
     ...
     * @return 契約者コード を戻します。
     */
    @LogInfo(columnIndex=6,columnJpName="契約者コード")
     ...
     * @return 建物区分 を戻します。
     */
    @LogInfo(columnIndex=7,columnJpName="建物区分")
     ...
     * @return カナ氏名 を戻します。
     */
    @LogInfo(columnIndex=8,columnJpName="カナ氏名")
     ...
     * @return 漢字氏名１ を戻します。
     */
    @LogInfo(columnIndex=9,columnJpName="漢字氏名１")
     ...
     * @return 漢字氏名２ を戻します。
     */
    @LogInfo(columnIndex=10,columnJpName="漢字氏名２")
     ...
     * @return 敬称 を戻します。
     */
    @LogInfo(columnIndex=11,columnJpName="敬称")
     ...
     * @return 漢字氏名３ を戻します。
     */
    @LogInfo(columnIndex=12,columnJpName="漢字氏名３")
     ...
     * @return 郵便番号 を戻します。
     */
    @LogInfo(columnIndex=13,columnJpName="郵便番号")
     ...
     * @return 住所１ を戻します。
     */
    @LogInfo(columnIndex=14,columnJpName="住所１")
     ...
     * @return 住所２ を戻します。
     */
    @LogInfo(columnIndex=15,columnJpName="住所２")
     ...
     * @return 丁目 を戻します。
     */
    @LogInfo(columnIndex=16,columnJpName="丁目")
     ...
     * @return 番地 を戻します。
     */
    @LogInfo(columnIndex=17,columnJpName="番地")
     ...
     * @return 号 を戻します。
     */
    @LogInfo(columnIndex=18,columnJpName="号")
     ...
     * @return 棟 を戻します。
     */
    @LogInfo(columnIndex=19,columnJpName="棟")
     ...
     * @return 部屋番号 を戻します。
     */
    @LogInfo(columnIndex=20,columnJpName="部屋番号")
     ...
     */
    @LogInfo(columnIndex=21,columnJpName="集合住宅コード")
     ...
     * @return 集合住宅名 を戻します。
     */
    @LogInfo(columnIndex=22,columnJpName="集合住宅名")
     ...
     * @return ＴＥＬ１ を戻します。
     */
    @LogInfo(columnIndex=23,columnJpName="ＴＥＬ１")
     ...
     * @return ＴＥＬ２ を戻します。
     */
    @LogInfo(columnIndex=24,columnJpName="ＴＥＬ２")
     ...
     * @return ＦＡＸ を戻します。
     */
    @LogInfo(columnIndex=25,columnJpName="ＦＡＸ")
     ...
     * @return メール を戻します。
     */
    @LogInfo(columnIndex=26,columnJpName="メール")
     ...
     * @return ＴＥＬ３ を戻します。
     */
    @LogInfo(columnIndex=27,columnJpName="ＴＥＬ３")
     ...
     * @return メール２ を戻します。
     */
    @LogInfo(columnIndex=28,columnJpName="メール２")
     ...
     * @return 備考 を戻します。
     */
    @LogInfo(columnIndex=29,columnJpName="備考")
     ...
     */
    @Override
    @LogInfo(columnIndex=30,columnJpName="登録者")
     ...
     */
    @Override
    @LogInfo(columnIndex=31,columnJpName="登録日")
     ...
     */
    @Override
    @LogInfo(columnIndex=32,columnJpName="更新者")
     ...
     */
    @Override
    @LogInfo(columnIndex=33,columnJpName="更新日")
     ...
     * @return 更新APP を戻します。
     */
    @LogInfo(columnIndex=34,columnJpName="更新APP")
     ...
     */
    @LogInfo(columnIndex=35,columnJpName="バージョン番号")
