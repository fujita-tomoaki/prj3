...
package jp.co.hanshin.itec.caty.common.model;
...
//--- プロパティメソッド
     ...
     * @return 連番 を戻します。
     */
    @LogInfo(columnIndex=2,columnJpName="連番")
     ...
     * @return 管理区分 を戻します。
     */
    @LogInfo(columnIndex=3,columnJpName="管理区分")
     ...
     */
    @LogInfo(columnIndex=4,columnJpName="任意設定KEY1")
     ...
     */
    @LogInfo(columnIndex=5,columnJpName="任意設定KEY2")
     ...
     * @return ファイル名 を戻します。
     */
    @LogInfo(columnIndex=6,columnJpName="ファイル名")
     ...
     * @return データ を戻します。
     */
    @LogInfo(columnIndex=7,columnJpName="データ")
